...
Current quartz-fit posture: do not cut the fused quartz for this tray workflow. The accepted bench approach is overlap/step geometry with a loose aluminum raft supporting the raised pane. Avoid hard clamps, sharp cut ends, screw heads, solder blobs, adhesive mounds, or any other point load against the 1 mm quartz. The quartz should be retained with light mechanical stops, raft geometry, or tray geometry, not compression.
...
- Before routine use, treat the eraser as a modified mains-powered tool: inspect cord routing, grommet fit, insulation, solder joints, switch/timer behavior, reflector tape adhesion, quartz plate placement, aluminum raft placement, and case closure.
